...
<br />
<!-- Profile picture -->
<img class="ProfilePic" img width="170" align="right" alt="Siyi Jiang" style="float: right; margin-left: 40px; margin-up: 25px; border-radius: 20px; background-color: rgba(255, 255, 255, 0.5);" src="pic240602.png">
