...
(2) The interconnection between **cognitive control** (also known as executive function or executive control) and bilingual language control during comprehension (Jiang, Ma, & Chen, [2023, BLC](https://doi.org/10.1017/S1366728922000323); [2024, BLC](https://doi.org/10.1017/S1366728923000494)) and production.<br /> 
